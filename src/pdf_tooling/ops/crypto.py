...
:class:`~pdf_tooling.secret.Secret` never enters either. What crosses into
...
:func:`~pdf_tooling.safety.atomic.plan_filesystem`'s own ``out_dir is None``
...
_ALREADY_ENCRYPTED: Final[str] = (
    "this document is already encrypted; run 'pdftooling decrypt' first"
)
...
class _Prediction:
    ...
    Mirrors :class:`~pdf_tooling.safety.atomic.PlannedOutputs`' X-67
