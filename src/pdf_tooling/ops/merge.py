...
module imports :func:`~pdf_tooling.ops.pagerange.is_valid_spec` and
:func:`~pdf_tooling.ops.pagerange.parse` and never re-implements a token
...
from pdf_tooling.ops.pagerange import ALL_PAGES_TOKEN, is_valid_spec, parse
...
def split_input_spec(raw: str) -> tuple[str, str | None]:
    ...
    (:func:`~pdf_tooling.ops.pagerange.is_valid_spec`). Otherwise the whole
