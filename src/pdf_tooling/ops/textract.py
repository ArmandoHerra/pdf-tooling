...
from pdf_tooling.models import ItemResult, OperationResult, PageText, TableGrid, TextBlock
...
from pdf_tooling.ports.text import (
    TABLE_STRATEGIES,
    ExtractedTable,
    TextLine,
    require_fast_text,
...
#: destination shapes, and :func:`~pdf_tooling.safety.atomic.plan_filesystem`
...
def _empty_page_warning(page: PageText) -> str:
    return (
        ...
        "— the page may be a scan; see 'pdftooling ocr'"
    )
