...
Design D5 -- why this module never shells out to `pdftooling text`
--------------------------------------------------------------------
...
from pdf_tooling.ports.compose import require_compose
from pdf_tooling.ports.structure import require_composite, require_structure
