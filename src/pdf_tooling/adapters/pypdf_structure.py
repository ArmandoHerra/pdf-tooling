...
from pdf_tooling.errors import AuthError, EngineMissingError, FailureError, NoInputError, UsageError
from pdf_tooling.models import DocumentInfo, PageInfo
...
from pdf_tooling.safety.paths import source_read_error
...
def _unlock_with_password(
    ...
    *,
    ...
    :class:`~pdf_tooling.secret.Secret`, whose ``source`` is safe-to-log by
