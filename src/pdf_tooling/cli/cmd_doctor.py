...
``pdftooling doctor -o json | jq '.ports[] | select(.available == false)'``, so
...
from pdf_tooling.cli.common import get_config, global_options
from pdf_tooling.cli.exit_codes import ENGINE_MISSING, OK
from pdf_tooling.output import OutputFormat, render_payload
from pdf_tooling.output.logging import get_logger
from pdf_tooling.ports import reset_cache, resolve_all
