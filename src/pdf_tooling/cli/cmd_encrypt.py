...
from pdf_tooling.ports.structure import ALWAYS_GRANTED_TOKENS, PERMISSION_TOKENS
...
def encrypt_command(
    ctx: typer.Context,
    source: Annotated[Path, operand_argument(metavar="PDF", help="The PDF to encrypt.")],
