...
:class:`~pdf_tooling.ops.document_password.PasswordSource` — a safe-to-log
...
from pdf_tooling.cli.common import not_a_readable_file
from pdf_tooling.errors import AuthError, UsageError
...
# would have made `pdf_tooling.safety.atomic.AtomicWriter` transitively
