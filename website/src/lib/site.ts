...
// astro.config.mjs verbatim -- with base: '/pdf-toolkit' (no trailing slash),
// BASE_URL is "/pdf-toolkit", NOT "/pdf-toolkit/". Naively concatenating a filename
// onto that ("${base}og-image.png") silently produces the broken path
// "/pdf-toolkitog-image.png". Normalize once here and reuse everywhere a public/
