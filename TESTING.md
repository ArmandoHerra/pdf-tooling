...
parameterizes 23 checks (`--help`, exit codes, dry-run purity,
...
PDF-38's `.bak` sidecar prediction over every `--in-place` verb, and
PDF-50's dangling-symlink twin of the same sidecar tier) over
that discovery.
