...
parameterizes 27 checks (`--help`, exit codes, dry-run purity,
...
operand, PDF-67's engine-blind disclosure row, and PDF-76's no-clobber
row over the `--out-dir`-only producers) over that discovery.
